...
def fex():
	...
	ua = f"[FBAN/FB4A;FBAV/{str(facebook_version)};FBBV/{str(fbbv)};[FBAN/FB4A;FBAV/{str(facebook_version)};FBBV/{str(fbbv)};FBDM/{{density={density},width={width},height={height}}};FBLC/es_MX;FBRV/{str(fbrv)};FBCR/TELCEL;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.mlite;FBDV/SM-G970U1;FBSV/10;FBOP/1;FBCA/arm64-v8a:null;]"
	return ua
