...
def baby():
	...
	MOBILE_MODEL = random.choice(["ASUS_I005DC"," SM-G780G","5003D_EEA"])
	BUILD = random.choice(["RKQ1.210303.002","TP1A.220624.014","OPM2.171019.012"])
	BUILD_VERSION = f'{random.randint(111111, 999999)}.{random.randint(111,999)}'
	FBBV = str(random.randint(10000000, 66666666))
	DENSITY = random.choice(['2.625','3.0',"1.5"])
	WIDTH = random.choice(["1080","1080","480"])
	HEIGHT = random.choice(["2322","2168"],"888")
	FB_VERSION = f"{random.randint(100, 450)}.{random.randint(0, 0)}.{random.randint(0, 0)}.{random.randint(1, 40)}.{random.randint(10, 150)}"
	FBLC = random.choice(["zh_TW_#Hant","pt_BR","en_GB"])
	FBRV = str(random.randint(000000000,999999999))
	FBCR = random.choice(["&amp","VIVO","O2 - UK"])
	FBMF = 'asus','samsung','TCL,
	FBBD = random.choice(['asus','samsung','TCL'])
	FBPN = random.choice(["com.facebook.katana","com.facebook.orca","com.facebook.orca"])
	FBOP = random.choice(["0","0","0"])
	FBCA = random.choice(["arm64-v8a;","arm64-v8a;","armeabi-v7a:armeabi"])
