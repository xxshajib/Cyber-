...
def baby():
	...
	MOBILE_MODEL = random.choice(["moto e","ASUS_I005DC","moto g power","SM-T835"])
	BUILD = random.choice(["QPGS30.82-135-16.","RKQ1.210303.002","RZBS31.Q2-143-27-7","QP1A.190711.020"])
	BUILD_VERSION = f'{random.randint(111111, 999999)}.{random.randint(111,999)}'
	FBBV = str(random.randint(10000000, 66666666))
	DENSITY = random.choice(['1.75','2.625','1.75','2.25'])
	WIDTH = random.choice(["720","1080","720,"1600"])
	HEIGHT = random.choice(["1422","2322","1488","2452"])
	...
	FBMF = 'motorola','asus','motorola','samsung'
	FBBD = random.choice(['motorola','asus','motorola','samsung'])
	FBPN = random.choice(["com.facebook.orca","com.facebook.katana","com.facebook.orca","com.facebook.orca"])
	FBOP = random.choice(["1"])
	FBCA = random.choice(["armeabi-v7a:armeabi;","arm64-v8a:armeabi;","arm64-v8a:armeabi;","armeabi-v7a:armeabi;"])
